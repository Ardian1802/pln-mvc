...
<head>
	...
	<link rel="stylesheet" type="text/css"  href="<?php echo AST; ?>/css/style.css">
...
<body>
			...
			<ul>
				...
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/team.png" alt=""> Pelanggan
					</a>
				</li>
				<li>
					<a href="<?php echo URL; ?>/golongan">
						<img class="icon" src="<?php echo AST; ?>/img/list.png" alt=""> Golongan
					</a>
				</li>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2022 - <?php echo date('Y'); ?>. Designed by Ardian
		</footer>
	</main>
