    ...
    <tbody>
        ...
        foreach ($data['rows'] as $row) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo URL; ?>/pelanggan/edit/<?php echo $row['pel_id']; ?>" class="btne">Edit</a></td>
                    <td><a href="<?php echo URL; ?>/pelanggan/delete/<?php echo $row['pel_id']; ?>" class="btnd">Delete</a></td>
                </tr>
        <?php $no++;
        } ?>
    </tbody>
